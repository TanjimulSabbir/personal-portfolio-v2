        ...
        {AllProjects?.Projects.map((project, index) => {
          ...
          return (
            <motion.div
              ...
              index % 2 == 0 ? index==0?"mt-10": "lg:mt-24" : "lg:mt-24"
              } mx-auto`}
            >
              <div>
              <h1
              ...
              {/* Text Part */}
              <div className="md:absolute left-0 md:top-20 pointer-events-none">
              <h2 className="my-5 md:mt-0 description md:text-end">
                A Quick Glance
              </h2>
              <div>
